...
public class CheckOutDao {
    ...
    public int checkOut(Customer customer){
        ...
        String query1 = "SELECT customer.*, room.* FROM customer JOIN room ON customer.roomNumber = room.roomNumber AND customer.deposit = ? WHERE customer.roomNumber = ? AND customer.deposit = ?";
        ...
        try {
            ...
            pstmt.setString(3, Integer.toString(customer.getDeposit()));
            ResultSet rs = pstmt.executeQuery();
            if(!rs.next()){
